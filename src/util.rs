...
pub const EXECUTABLE_RECIPE_STUB: &'static str = include_str!("../inc_files/executable_recipe_stub.txt");

pub const STATICLIB_HELLO_WORLD: &'static str  = include_str!("../inc_files/staticlib_hello_world.c2");
pub const STATICLIB_RECIPE_STUB: &'static str  = include_str!("../inc_files/staticlib_recipe_stub.txt");
